...
<body>
	...
	<h2>Private messaging with ${message.receiver}</h2>

	<c:if test="${newmessages}">You have <span class="blink_me"><a
			href="${pageContext.request.contextPath}/board/pmto?show=new">new private messages!</a>
			</span>
	</c:if>

	<div class="mform">
		<form:form method="POST"
			action="${pageContext.request.contextPath}/board/pmto/${message.receiver}"
